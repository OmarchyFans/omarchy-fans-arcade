...
// Solder Snap runs as its own Quickshell process (bin/arcade: quickshell -n -p
// games/solder/shell.qml), never inside the Omarchy bar, so nothing it does can
...
ShellRoot {
  ...
  readonly property string scoreFile: stateHome + "/omarchy-arcade/solder.json"
